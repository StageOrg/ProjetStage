...
export default function MenuLateralAdmin() {
  ...
  return (
    <aside className="hidden md:flex flex-col gap-4 bg-white/200 backdrop-blur-2xl shadow-2xl w-64 h-screen sticky top-0 z-10 py-0 px-0  border-r border-blue-900">
